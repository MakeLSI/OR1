...
set techfile=OpenRule1um	;# magic techfile
set magicrc=OpenRule1um.magicrc	;# magic startup script
set gdsfile=OpenRule1um_stdcells.gds	;# GDS database of standard cells
